      ...
      <div className="container mx-auto px-5 md:px-10">
        ...
        <div className="grid h-[135vh] grid-cols-2 grid-rows-3 gap-7">
          ...
          <BentoTilt className="bento-tilt-2">
            <div className="flex size-full flex-col justify-between bg-violet-300 p-5 xl:h-[130%] rounded-[2%] xl:rounded-[3%] xl:relative">
              <h1 className="bento-title special-font max-w-64 text-black">
                M<b>o</b>re Co<b>m</b>ing s<b>o</b>on!
              </h1>
              <TiLocationArrow className="m-5 scale-[5]  self-end xl:absolute xl:bottom-[10%]" />
            </div>
          </BentoTilt>
          <BentoTilt className="bento-tilt_2 -5 xl:h-[130%] rounded-[2%]` xl:rounded-[3%]">
            <video
